# WAF Web ACL Module
# This module creates a WAF Web ACL for CloudFront distributions
...
resource "aws_wafv2_web_acl" "main" {
  ...
  # AWS managed rule set for SQL injection
  rule {
  ...
  # AWS managed rule set for Linux OS
  rule {
  ...
  # AWS managed rule set for Windows OS
  rule {
