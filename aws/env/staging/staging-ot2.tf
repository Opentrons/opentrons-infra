...
# ot2.staging.designer.opentrons.com and ot2.staging.labware.opentrons.com - independent S3 + CloudFront per app.
...
module "ot2_protocol_designer_certificate" {
  ...
  tags = merge(local.common_tags, {
    ...
    Name    = "ot2-protocol-designer-staging"
  })
...
module "ot2_protocol_designer_cloudfront_distribution" {
  ...
  comment                 = "Staging ot2 protocol designer (separate infra)"
  ...
  custom_user_agent       = "Opentrons-Protocol-Designer-Staging-OT2"
...
resource "aws_route53_record" "ot2_staging_designer" {
...
module "ot2_labware_library_certificate" {
  ...
  tags = merge(local.common_tags, {
    ...
    Name    = "ot2-labware-library-staging"
  })
...
module "ot2_labware_library_cloudfront_distribution" {
  ...
  enabled                 = true
  is_ipv6_enabled         = true
  comment                 = "Staging ot2 labware library (separate infra)"
  default_root_object     = "index.html"
  price_class             = "PriceClass_100"
  ...
  custom_user_agent       = "Opentrons-Labware-Library-Staging-OT2"
  ...
  tags = merge(local.common_tags, {
    Name = "ot2.staging.labware.opentrons.com"
  })
...
resource "aws_route53_record" "ot2_staging_labware" {
